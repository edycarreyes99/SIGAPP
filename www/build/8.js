...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__list_master__ = __webpack_require__(903);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_database__ = __webpack_require__(393);
...
var ListMasterPage = /** @class */ (function () {
    function ListMasterPage(navCtrl, items, modalCtrl, db) {
        this.navCtrl = navCtrl;
        this.items = items;
        this.modalCtrl = modalCtrl;
        this.db = db;
        this.estudiantes = this.db.list('/Estudiantes').snapshotChanges().map(function (changes) {
